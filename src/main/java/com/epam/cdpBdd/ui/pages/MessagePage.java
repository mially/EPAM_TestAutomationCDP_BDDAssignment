...
public class MessagePage {
    ...
    public void markLetterAsSpam(WebDriver driver) {
        ...
        if (!markAsSpamButtons.isEmpty()) {
            ...
            System.out.println("Message is marked as spam");
        } else {
            System.out.println("Can't mark this message as spam!");
        }
    }
    ...
    public void unSpamLetter(){
        if (!unmarkAsSpamButtons.isEmpty()) {
            ...
            System.out.println("Message is un-marked as Spam");
        } else {
            System.out.println("No unspam element on the page");
        }
    }
