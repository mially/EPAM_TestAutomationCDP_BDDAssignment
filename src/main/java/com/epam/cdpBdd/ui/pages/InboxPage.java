...
public class InboxPage {
    ...
    public void searchForMessageInInboxAndMarkAsSpam (WebDriver driver, String title) {
        ...
        for (WebElement element : emailTitles) { //search in Inbox
            if (element.getText().contains(title)) {
                System.out.println("Message '" + title + "' found in Inbox");
                element.click();
        ...
        System.out.println("Didn't get a message");
    }
    ...
    public SpamPage goToSpam(WebDriver driver) {
        ...
        try {
            ...
            System.out.println("Spam page is loaded");
        } catch (Exception e) {
            System.out.println("Unable to go to spam page, " + e.getMessage());
        }
    ...
    public void logout(WebDriver driver) {
        ...
        try {
            ...
            System.out.println("No alert this time");
        }
        try {
            UtilsMethods.getWait().until(ExpectedConditions.urlContains("accounts.google.com"));
            System.out.println("Logged out");
        } catch (Exception e) {
            System.out.println("Unable to log out, " + e.getMessage());
        }
    }
